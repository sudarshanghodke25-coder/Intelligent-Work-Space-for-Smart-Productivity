...
class AssistantView(ctk.CTkFrame):
    def __init__(self, parent, **kwargs):
        ...
        ctk.CTkLabel(chat_area, text="Aurex: How can I help you today?", font=Fonts.BODY, text_color=Colors.TEXT_PRIMARY, anchor="w", fg_color=Colors.GLASS_FILL_LIGHT, corner_radius=8, padx=10, pady=10).pack(fill="x", pady=5)
        
        input_frame = ctk.CTkFrame(card.content, fg_color="transparent", height=50)
        input_frame.pack(fill="x")
        
        ctk.CTkEntry(input_frame, placeholder_text="Type a message...", font=Fonts.BODY, fg_color=Colors.ENTRY_BG, border_color=Colors.ENTRY_BORDER).pack(side="left", fill="x", expand=True, padx=(0, 10))
